...
declare module 'leaflet' {
	...
	class TrackSymbol extends Path {
         ...
         * @param symbol {number[]} The corner points of the symbol. 
         */
        setDefaultSymbol(symbol: number[]): this;
         ...
         * @param symbol {number[]} The corner points of the symbol. 
         */
        setNoHeadingSymbol(symbol: number[]): this;
         ...
         * @param symbol {number[]} The corner points of the symbol. 
         */
        setSilouetteSymbol(symbol: number[]): this;
